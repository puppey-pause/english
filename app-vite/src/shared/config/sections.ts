...
export const SECTIONS: { label: string; view: ViewId; desc: string; keywords: string }[] = [
  ...
  { label: "чтение", view: "reading", desc: "тексты по уровням A1–C1 со словами и вопросами", keywords: "чтение текст читать reading уровень абзац" },
  { label: "тренажёр", view: "drills", desc: "задания: найди ошибку, вставь слово, собери фразу", keywords: "тренажёр упражнен задани практик" },
  { label: "печать текста", view: "typing", desc: "набор фраз с клавиатуры: по памяти, копия, диктант", keywords: "печат набор клавиатур диктант typing скорост слепо" },
